    ...
    <div class="container">
        <div class="d-md-flex">
            <div class="w3ls_banner_txt">
                ...
                <a href=<?=Url::to('/startup/about')?> class="btn button-style mt-md-5 mt-4">Read More</a>
            </div>
        ...
        <div class="row about-bottom-w3l text-center mt-4">
            <div class="col-lg-4 about-grid">
                <div class="about-grid-main">
                    ...
                    <a href=<?=Url::to('/startup/about')?> class="button-w3ls btn mt-sm-5 mt-4">Read More</a>
                </div>
            </div>
    ...
    <div class="container py-xl-5 py-lg-3">
        <div class="row">
            <div class="col-lg-6 about-right-faq">
                ...
                <a href=<?=Url::to('/startup/about')?> class="btn button-style button-style-2 mt-sm-5 mt-4">Read More</a>
            </div>
